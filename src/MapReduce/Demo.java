	             ...
	             for(int i=0;i<tuple.length; i++)
	             {
	            	 ...
	            	 if(bus.reviewCount != null && Integer.parseInt(bus.reviewCount) > 3)
	            	 {
	            		 ...
	            		 if(info!= null && bus.city!= null){
	            		     //context.write(new Text(bus.name), info);
	            		     context.write(new Text(bus.businessId), new Text("\t" + bus.name + "\t" + bus.category + "\t" + bus.reviewCount + "\t" + bus.stars + "\t" + bus.open + "\t" + bus.full_address + "\t" + bus.city + "\t" + bus.state + "\t" + bus.latitude + "\t" + bus.longitude));
	            		 }
	            	 }
	              }
